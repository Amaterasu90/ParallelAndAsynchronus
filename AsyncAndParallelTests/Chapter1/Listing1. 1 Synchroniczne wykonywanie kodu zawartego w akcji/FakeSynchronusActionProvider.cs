...
{
    public class FakeSynchronusActionProvider : SynchronusActionProvider
    {
        public FakeSynchronusActionProvider(TimeProvider timeProvider, WaitingManager waitingManager) : base(waitingManager)
        {
            base.TimeProvider = timeProvider;
        }
    }
}
